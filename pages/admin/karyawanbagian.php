...
if (isset($_GET['id'])){
    ...
    if (isset($row['id'])){
        if(isset($_POST['button_update'])){
            ...
            echo "<metta http-equiv='refresh' content='1;url=?page=karyawanbagian&id=" . $_POST['karyawan_id'] . "'>";
        }
                ...
                <div class="card-body"> 
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="handphone" class="form-control" value="<?= $row['handphone']?>" disabled>
                        </div>
                        </div>
                        <div class="col-sm-12">
                        <div class=" form-group">
                            <label for="nama_lengkap">Nama Lengkap</label>
                            <input type="text" name="nama_lengkap" class="form-control" value="<?= $row['nama_lengkap']?>" disabled>
                        </div>
                    </div>
                    </div>
